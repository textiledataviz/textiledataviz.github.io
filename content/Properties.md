...
* [[negative-space|negative space]]: using emptiness (gaps, holes, unembroidered fabric, etc.) to represent data, or the absence of data
...
* [[recreating-dataviz|recreating dataviz]]: not exactly a textile property, but an approach -- using a textile medium to create traditional data visualization shapes
