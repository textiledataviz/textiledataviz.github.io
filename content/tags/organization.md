...
Still, the spatial arrangement of the other properties in your textile can hold meaning. One of the most common ways to use organization is for it to represent time, by presenting data chronologically. If you're [[Creating Data from Text|visualizing a text]], it's natural to present the data in the order in which it occurred in the text (e.g. if visualizing properties of words, the first word comes first, then the second, etc.)